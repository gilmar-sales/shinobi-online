function onLogin(cid)
    ...
    if getPlayerStorageValue(cid, initStorages.init) <= 0 then
        ...
        doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE,
            "Bem-vindo ao otNaruto, sua primeira missao e ir a academia para comecar o seu teste gennin procure por Tekuno e entao comece seu treinamento, logo comecara a sua aventura ninja! (Academia marcada no minimap)")
