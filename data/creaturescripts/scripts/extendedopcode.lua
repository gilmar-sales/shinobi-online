function onExtendedOpcode(cid, opcode, buffer, param)
    local missionInfo = "D = " ..
    getPlayerStorageValue(cid, sto_missao[2]) ..
    "  De-C = " ..
    getPlayerStorageValue(cid, sto_missao[3]) ..
    " Ce-B =  " ..
    getPlayerStorageValue(cid, sto_missao[4]) ..
    " Be-A =  " ..
    getPlayerStorageValue(cid, sto_missao[5]) .. " Ae-S =  " .. getPlayerStorageValue(cid, sto_missao[6]) .. " Se-"
    -----------------DOGINFO---------------------------
    ...
    if opcode == 106 then
        ...
        if pet then
            local dogInfo = "HP = " ..
            getCreatureHealth(pet) ..
            "  MHP = " ..
            getCreatureMaxHealth(pet) ..
            " HPe-LV = 1 LVe-CL = " ..
            getCreatureMana(pet) ..
            "  MCL = " ..
            getCreatureMaxMana(pet) ..
            " CLe-HPe-LVPET = " ..
            getPetLevel(pet) ..
            " LVPETe-XP = " ..
            getPetExperience(pet) ..
            " XPe-SP = " ..
            getCreatureSpeed(pet) ..
            " SPe-SCL = " ..
            getPetChakraLevel(cid) ..
            " SCLe-SRT = " ..
            getPetResistenceLevel(cid) .. " SRTe-DS = " .. getPetSkill(cid) .. " DSe-PSS = " ..
            getPetSpeed(cid) .. " PSSe-"
    ...
    if opcode == 97 then
        if buffer == "resistanceButton" then
            ...
            if pet then
                ...
                getPetChakraLevel(cid) ..
                " SCLe-SRT = " ..
                getPetResistenceLevel(cid) .. " SRTe-DS = " ..
                getPetSkill(cid) .. " DSe-PSS = " .. getPetSpeed(cid) .. " PSSe-"
                doSendPlayerExtendedOpcode(cid, 102, dogInfo)
            end
    ...
    elseif opcode == 53 then
        local values = "" ..
        getPlayerStorageValue(cid, STAMINA_STORAGE) .. "/" .. getPlayerStorageValue(cid, STAMINAMAX_STORAGE) .. ""
