function onKill(cid, target, lastHit)
    ...
    if pet then
        ...
        " SPe-SCL = " ..
        getPetChakraLevel(cid) .. " SCLe-SRT = " .. getPetResistenceLevel(cid) ..
        " SRTe-DS = " .. getPetSkill(cid) .. " DSe-"
        ...
        if getLevelByExp(getPetExperience(pet)) > getPetLevel(pet) then
            doPlayerSendTextMessage(cid, MESSAGE_EVENT_ADVANCE,
                "Your pet advanced from level " ..
                getPetLevel(pet) .. " to level " .. getLevelByExp(getPetExperience(pet)) .. ".")
            ...
            " SCLe-SRT = " .. getPetResistenceLevel(cid) .. " SRTe-DS = " .. getPetSkill(cid) .. " DSe-"
            doSendPlayerExtendedOpcode(cid, 102, dogInfo)
        end
        return true
    end
