...
function getDirectionBetween(fromPos, toPos, directions)
    ...
    local DIR = {
        { dify, -difx, -dify, difx }, { dify - math.abs(difx), -difx - math.abs(dify), -dify - math.abs(difx), difx -
    math.abs(dify),
        difx - dify - math.abs(difx), -dify - math.abs(-difx) - difx, dify - math.abs(difx) + difx, dify -
    math.abs(-difx) - difx }
    }
