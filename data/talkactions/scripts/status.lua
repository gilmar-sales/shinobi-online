function onSay(cid, words, param, channel)
    ...
    if isInArray({ "magic" }, param) then
        ...
        if getPlayerSoul(cid) >= 3 then
            ...
            doPlayerSendTextMessage(cid, 27, "voc� precisa ter 3 pontos.")
            return true
        end
    end
    if isInArray({ "magic energy" }, param) then
        ...
        if getPlayerSoul(cid) >= 2 then
            ...
            doPlayerSendTextMessage(cid, 22,
                "You're now better at magic energy [" .. getPlayerStorageValue(cid, ManaSTO) .. "].")
        else
            doPlayerSendTextMessage(cid, 27, "voc� ainda n�o tem pontos.")
            return true
        end
    end
    if isInArray({ "knowledge" }, param) then
        ...
        if getPlayerSoul(cid) >= 2 then
            ...
            doSendAnimatedText(getThingPos(cid), "UPGRADE", 100)
            doPlayerSendTextMessage(cid, 22,
                "You're now better at knowledge [" .. getPlayerStorageValue(cid, KnowledgeSTO) .. "].")
        else
            doPlayerSendTextMessage(cid, 27, "voc� ainda n�o tem pontos.")
            return true
        end
    ...
    if isInArray({ "intelligence" }, param) then
        ...
        if getPlayerSoul(cid) >= 2 then
            ...
            doSendAnimatedText(getThingPos(cid), "UPGRADE", 100)
            doPlayerSendTextMessage(cid, 22,
                "You're now better at intelligence [" .. getPlayerStorageValue(cid, IntSTO) .. "].")
        else
            doPlayerSendTextMessage(cid, 27, "voc� ainda n�o tem pontos.")
            return true
        end
