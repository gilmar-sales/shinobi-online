...
public:
    ...
    uint32_t onCreatureMove(Creature *actor, Creature *creature, const Tile *fromTile, const Tile *toTile,
                            bool isStepping);
...
protected:
    ...
    virtual LuaScriptInterface &getInterface()
    {
        return m_interface;
    }
...
public:
    ...
    //scripting
    uint32_t executeStep(Creature *actor, Creature *creature, Item *item, const Position &pos, const Position &fromPos,
